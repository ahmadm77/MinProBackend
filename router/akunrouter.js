...
router.get('/k', verifyToken, authlogin.keeplogin);
router.patch('/cp', verifyToken, cCPass , userController.editPass);
...
router.post('/chFP', verifyToken, multerUpload('./public/Profile', 'profile').single('file') , userController.upProfile);
